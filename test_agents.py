...
from eleventh_agent import EleventhAgent
from twelve_agent import TwelveAgent
from thirteeth_agent import ThirteenthAgent
...
agent = ThirteenthAgent()  
opponent = TwelveAgent()  
test_agents(agent, opponent, 2)
