...
# EleventhAgent: Hybrid agent that switches between Lasso (defensive) and Ridge (positional)
class EleventhAgent(StudentAgentWithCache):
    def __init__(self):
        super().__init__()
    ...
    def evaluate(self, state):
        ...
        lasso_weights = np.array([
            ...
            +0.0000, -0.0000, -1.8251, +0.1544, -0.1651, -0.0084,
            +0.0190, -0.0020
        ])
        ...
        ridge_weights = np.array([
            ...
            +0.0000, -0.5526, -1.9342, +0.0885, -0.0854, +0.0226,
            +0.0885, -0.0854
        ])
