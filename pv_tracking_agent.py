...
class PVTrackingAgent(ABC):
    def __init__(self):
        self.global_cache = {}
        self.killer_moves = {}  # store killer moves by depth
        self.last_action_scores = {}
        self.principal_variation = {}  # best actions by depth
    ...
    def search_with_depth(self, state, depth, start_time, time_limit):
        ...
        # Use PV move first, then killer, then scores
        pv = self.principal_variation.get(depth, None)
        ...
        self.principal_variation[depth] = best_action
        return best_action
