...
from utils import State, load_data  # Assuming the State class is already implemented in utils
...
def get_data():
    ...
    data = []  # Store (features, utility) pairs
    for state, true_utility in load_data():  # Assuming load_data() gives pairs of (state, utility)
